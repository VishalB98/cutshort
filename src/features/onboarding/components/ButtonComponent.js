...
function ButtonComponent(props) {
    return (
        <div>
            <button className="w-[400px] bg-primary text-[white] font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="button" onClick={props.moveScreen} disabled={ NUMBEROFONBOARDINGSTEP === props.screenNumber } >
